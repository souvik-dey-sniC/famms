...
<html>
   <head>
      ...
      <title>Famms - Fashion House</title>
      <!-- bootstrap core css -->
   ...
   <?php
        ...
        if(isset($_GET['message']))
        {
            ...
            if($res == 1)
            {
               ...
               echo'
                ...
                backdrop: `
                    ...
                    no-repeat
                `,
                footer: `<a style="color: orange; "href="cart.php">Go To Cart</a>`
                });
                </script>
                ';
            }
            else if($res == 2)
            {
               ...
               echo'
                <script>
                Swal.fire({
                title: "Product Already Added into Cart",
                showClass: {
                    popup: `
                    animate__animated
                    animate__fadeInUp
               ...
               //echo "Product not Added into Cart";
               echo'
                <script>
                Swal.fire({
                icon: "error",
    ...
    ?>
      ...
      <!-- if($res  == 1) {
        ...
        echo "Product Alrady Added into Your Cart.. Same Product You Will Not Added!";
    }
    else {
        echo "Product Not Added!!";
    } -->
      <!-- end arrival section     onclick="addToCart('.$data["productid"].')"-->
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4">
                           <div class="box">
                              <div class="option_container">
                                 <div class="options">
                                 <a href="AddToCart.php?pid='.$data["productid"].'" class="option1">
                                 Add To Cart
                                 </a>
                                 <a href="checkout.php?flag=2&productid='.$data["productid"].'" class="option2">
                                 Buy Now
                                 </a>
                              </div>
                           </div>
