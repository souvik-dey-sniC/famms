...
<html>
	<head>
		<meta charset="utf-8">
		<title>famms User Updation</title>
			...
			<div class="inner">
				...
				<form action="" method="post">
					...
					<div class="form-holder">
						<span></span>
						<input type="text" name="email" class="form-control" placeholder="Mail" value="<?php echo $data['email'] ?>" readonly>
					</div>
					<div class="form-holder">
						<span></span>
						<input type="text" name="name" class="form-control" placeholder="Username" value="<?php echo $data['name'] ?>">
					</div>
					<div class="form-holder">
						<span></span>
